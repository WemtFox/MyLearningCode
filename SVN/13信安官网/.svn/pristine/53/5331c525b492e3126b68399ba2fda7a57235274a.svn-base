<?php 
	...
	if($sql->update_hw($week ,$probability1, $probability2, $db1, $db2, $discrete1, $discrete2, $english1, $english2,$digi1,$digi2)){
		if($save == 1){
		$sql ->insert_hw($week, $probability1, $probability2, $db1, $db2, $discrete1, $discrete2, $english1, $english2,$digi1,$digi2);
		}
		echo "<script>alert(\"恭喜你，更新作业成功\");</script>";
	}
	else{
	echo "<script>alert(\"更新作业失败！！！！\");</script>";;
	}
 ?>