        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li  class="active"><a href="./hwBefore.php">作业回顾</a>
                    </li>
                    <li><a href="./tongBefore.php">通知回顾</a>
                    </li>
            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-info" id="hw">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item list-group-item-warning"><span class="glyphicon glyphicon-send"></span>&nbsp;操作系统原理</li>
                        <li class="list-group-item"><span class="glyphicon glyphicon-info-sign"></span>
                            <?=$hw[ "discrete1"] ?>
                        </li>
                        <li class="list-group-item"><span class="glyphicon glyphicon-info-sign"></span>
                        ...
                        <li class="list-group-item list-group-item-warning"><span class="glyphicon glyphicon-send"></span>&nbsp;马克思主义基本原理概论</li>
                        <li class="list-group-item"><span class="glyphicon glyphicon-info-sign"></span>
                            <?=$hw[ "digi1"] ?>
                        </li>
                        <li class="list-group-item"><span class="glyphicon glyphicon-info-sign"></span>
