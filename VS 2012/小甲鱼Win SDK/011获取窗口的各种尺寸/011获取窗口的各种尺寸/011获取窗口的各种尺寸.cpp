// 011获取窗口的各种尺寸.cpp : 定义应用程序的入口点。
//

#include "stdafx.h"
#include "011获取窗口的各种尺寸.h"
#include "strsafe.h"
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_MY011, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY011));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_MY011);
